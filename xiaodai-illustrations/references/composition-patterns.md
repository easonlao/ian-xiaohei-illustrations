...
不要默认打开或复刻 `assets/examples/`。这些图片仅用于风格与构图校准（例如线条密度、留白、颜色克制、荒诞隐喻的意图）。请注意，这些旧例图中画的是旧版“眼镜男”形象，生图时千万不要模仿或复刻旧角色的外观细节，必须仅以最新的 standard-xiaodai.png（纯红小火人）作为 IP 垫图和相貌特征参考。
